...
/**
 * Exception instance used to raise error in transforming entities.
 */
public class TransformtationException extends Exception {
     ...
     */
    public TransformtationException(String s) {
     ...
     */
    public TransformtationException(String s, Throwable throwable) {
     ...
     * @param throwable - Inner cause.
     */
    public TransformtationException(Throwable throwable) {
